// Get the WebGL context.
            var canvas = document.getElementById('form2');
            ...
            gl.vertexAttrib4f(colAttrib, 0.9607843137254902, 0.796078431372549, 0.3607843137254902, 1);
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, iboTris);
            ...
            function createVertexData(){
                ...
                for(var i=0, t=0; i <= n; i++, t += dt) {
                    ...
                    for(var j=0, r=0; j <= m; j++, r += dr){
                        ...
                        var x = k* Math.sin(t) * Math.cos(r);
                        var z = k* Math.sin(t) * Math.sin(r);
                        var y = k* Math.cos(t);
