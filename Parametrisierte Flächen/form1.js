// Get the WebGL context.
            var canvas = document.getElementById('form1');
            ...
            gl.vertexAttrib4f(colAttrib, 0.3137254901960784, 0.3137254901960784, 0.30980392156862746, 1);
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, iboTris);
            ...
            function createVertexData(){
                ...
                for(var i=0, t=0; i <= n; i++, t += dt) {
                    ...
                    for(var j=0, r=0; j <= m; j++, r += dr){
                        ...
                        var x = Math.cos(t) * Math.cos(2*r);
                        var z = Math.sin(t) * Math.cos(2*r);
                        var y = -2*Math.sin(r);
